...
import { strings } from '@douyinfe/semi-foundation/lib/cjs/feedback/constants';
...
import FeedbackFoundation from '@douyinfe/semi-foundation/lib/cjs/feedback/foundation';
import { RadioChangeEvent } from '../radio';
import '@douyinfe/semi-foundation/lib/cjs/feedback/feedback.css';
