...
class InputNumber extends _baseComponent.default {
  ...
  _getInitState(props) {
    ...
    if ((0, _isNullOrUndefined.default)(propsValue) || propsValue === '') {
      return {
        value: '',
        number: null
      };
...
InputNumber.propTypes = {
  ...
  scientificNotation: _propTypes.default.oneOfType([_propTypes.default.bool, _propTypes.default.object]),
