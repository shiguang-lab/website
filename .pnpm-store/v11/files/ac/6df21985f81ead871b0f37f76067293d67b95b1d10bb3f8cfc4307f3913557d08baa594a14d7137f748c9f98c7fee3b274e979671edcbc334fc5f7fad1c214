...
import { ContainerAdapter, ContainerProps, ContainerState } from '@douyinfe/semi-foundation/lib/es/sidebar/containerFoundation';
import { Enable } from '@douyinfe/semi-foundation/lib/es/resizable/types';
