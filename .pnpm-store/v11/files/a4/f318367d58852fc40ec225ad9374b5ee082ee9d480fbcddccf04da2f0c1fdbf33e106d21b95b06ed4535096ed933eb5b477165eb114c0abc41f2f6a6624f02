...
function checkVersionCompatibility() {
  ...
  if (mainVersion < 18 && typeof ((_a = semiGlobal.config) === null || _a === void 0 ? void 0 : _a.createRoot) === 'function') {
...
function resolveCreateRoot() {
  var _a;
  if (typeof ((_a = semiGlobal.config) === null || _a === void 0 ? void 0 : _a.createRoot) === 'function') {
    return semiGlobal.config.createRoot;
  }
 ...
 */
export function resolveDOM(instance) {
  if (!instance) {
    return null;
  }
  // 已经是 Element，直接返回
