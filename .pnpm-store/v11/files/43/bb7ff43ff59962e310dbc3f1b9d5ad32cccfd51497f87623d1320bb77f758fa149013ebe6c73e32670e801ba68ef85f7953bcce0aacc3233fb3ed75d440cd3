...
import type { SearchWords } from '@douyinfe/semi-foundation/lib/cjs/highlight/foundation';
...
declare class Highlight extends PureComponent<HighlightProps> {
    ...
    getHighLightTextHTML: ({ sourceString, searchWords, option }: GetHighLightTextHTMLProps) => (string | React.ReactElement<{
        style: {
