...
class TagInput extends _baseComponent.default {
  constructor(props) {
    ...
    this.updateInputWidth = () => {
      ...
      const mirrorText = inputValue || ((tagsArray === null || tagsArray === void 0 ? void 0 : tagsArray.length) === 0 ? placeholder : '') || ' ';
    ...
    this.renderTag = (value, index, sortableHandle) => {
      ...
      const onClose = function () {
        ...
        !disabled && _this.handleTagClose(index);
      };
    ...
    this.inputMirrorRef = /*#__PURE__*/_react.default.createRef();
  ...
  componentDidUpdate(prevProps, prevState) {
    var _a, _b;
    if (prevState.inputValue !== this.state.inputValue || prevProps.size !== this.props.size || prevProps.placeholder !== this.props.placeholder || ((_a = prevState.tagsArray) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = this.state.tagsArray) === null || _b === void 0 ? void 0 : _b.length)) {
      this.updateInputWidth();
    }
  }
  renderClearBtn() {
  ...
  render() {
    ...
    return (
      ...
      }, this.renderTags(), /*#__PURE__*/_react.default.createElement("span", {
        ref: this.inputMirrorRef,
        className: `${prefixCls}-wrapper-inputMirror`
