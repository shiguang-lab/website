...
import type { Annotation, ContentItem, InputFile, InputImage, Message } from '@douyinfe/semi-foundation/lib/cjs/aiChatDialogue/foundation';
import type { MessageContent } from '@douyinfe/semi-foundation/lib/cjs/aiChatInput/interface';
