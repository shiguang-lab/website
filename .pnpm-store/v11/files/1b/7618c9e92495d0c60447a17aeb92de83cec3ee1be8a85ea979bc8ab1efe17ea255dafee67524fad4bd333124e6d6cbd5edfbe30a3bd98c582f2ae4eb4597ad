...
class Table extends BaseComponent {
  ...
  componentDidMount() {
    ...
    const checkRelation = _get(this.state.rowSelection, 'checkRelation', 'unRelated');
  ...
  componentDidUpdate(prevProps, prevState) {
     ...
     */
    const nextGetCheckboxProps = _get(this.props.rowSelection, 'getCheckboxProps');
    const prevGetCheckboxProps = _get(prevProps.rowSelection, 'getCheckboxProps');
...
Table.propTypes = {
  ...
  getVirtualizedListRef: PropTypes.func,
