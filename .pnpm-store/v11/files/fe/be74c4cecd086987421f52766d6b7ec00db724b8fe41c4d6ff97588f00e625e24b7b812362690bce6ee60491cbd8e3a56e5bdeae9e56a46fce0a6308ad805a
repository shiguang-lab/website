...
class Body extends _baseComponent.default {
  constructor(props, context) {
    ...
    super(props);
    _this = this;
    this.onRowHover = (isHover, rowKey) => {
      const {
        store
      } = this.props;
      const {
      ...
      if (store) {
        ...
        const prevHoveredRowKey = (0, _get2.default)(store.getState(), 'hoveredRowKey');
    ...
    this.updateRowHoverClass = nextKeys => {
      var _a;
      ...
      const root = ((_a = bodyNode.closest) === null || _a === void 0 ? void 0 : _a.call(bodyNode, `.${this.props.prefixCls}-wrapper`)) || bodyNode;
     ...
     */
    this.getHoveredRowKeysFromDOM = currentRowKey => {
      var _a;
      const keys = new Set();
      keys.add(currentRowKey);
      const root = this.ref.current;
      const tbody = (_a = root === null || root === void 0 ? void 0 : root.querySelector('.semi-table-tbody')) !== null && _a !== void 0 ? _a : root;
      if (!tbody) {
