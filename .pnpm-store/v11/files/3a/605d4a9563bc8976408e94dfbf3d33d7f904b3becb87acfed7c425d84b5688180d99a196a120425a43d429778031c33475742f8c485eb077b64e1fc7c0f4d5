...
class DropdownItemInner extends _baseComponent.default {
  render() {
    const {
      children,
      disabled,
...
DropdownItemInner.contextType = _context.default;
DropdownItemInner.defaultProps = {
  disabled: false,
  divided: false,
  selected: false,
...
const DropdownItem = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  return /*#__PURE__*/_react.default.createElement(DropdownItemInner, Object.assign({}, props, {
    innerRef: ref
  }));
});
