...
class Combobox extends _baseComponent.default {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevProps.timeStampValue !== this.props.timeStampValue || prevProps.format !== this.props.format || prevProps.hideDisabledOptions !== this.props.hideDisabledOptions || prevProps.use12Hours !== this.props.use12Hours || prevProps.hourStep !== this.props.hourStep || prevProps.minuteStep !== this.props.minuteStep || prevProps.secondStep !== this.props.secondStep || prevProps.disabledHours !== this.props.disabledHours || prevProps.disabledMinutes !== this.props.disabledMinutes || prevProps.disabledSeconds !== this.props.disabledSeconds) {
