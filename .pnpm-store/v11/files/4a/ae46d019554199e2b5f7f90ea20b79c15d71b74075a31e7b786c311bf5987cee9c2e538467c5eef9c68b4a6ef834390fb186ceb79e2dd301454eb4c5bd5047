...
class Cascader extends _baseComponent.default {
  ...
  static getDerivedStateFromProps(props, prevState) {
    ...
    const getRealKeys = (realValue, keyEntities) => {
      ...
      normalizedValue.forEach(valueItem => {
        const formatItem = onChangeWithObject && (0, _isObject2.default)(valueItem[0]) ? (0, _util.getValueOrKey)(valueItem, keyMaps) : valueItem;
    ...
    if (multiple) {
      ...
      if (needUpdateTreeData || needUpdateValue) {
        ...
        if (needUpdateTreeData) {
          ...
          keyEntities = (0, _util.convertDataToEntities)(props.treeData, keyMaps);
  ...
  componentDidUpdate(prevProps) {
    ...
    const treeDataChanged = !(0, _isEqual2.default)(prevProps.treeData, this.props.treeData);
    const keyMapsChanged = !(0, _isEqual2.default)(prevProps.keyMaps, this.props.keyMaps);
