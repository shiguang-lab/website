...
class Transfer extends _baseComponent.default {
  constructor(props) {
    ...
    this.state = {
      ...
      inputValue: '',
      leftCurrentPage: (_b = (_a = pagination === null || pagination === void 0 ? void 0 : pagination.defaultCurrentPage) !== null && _a !== void 0 ? _a : pagination === null || pagination === void 0 ? void 0 : pagination.currentPage) !== null && _b !== void 0 ? _b : 1
    };
  ...
  get adapter() {
    return Object.assign(Object.assign({}, super.adapter), {
      ...
      updateCurrentPage: currentPage => {
        this.setState({
          leftCurrentPage: currentPage
        });
      },
      notifyPageChange: currentPage => {
        var _a, _b;
        (_b = (_a = this.props.pagination) === null || _a === void 0 ? void 0 : _a.onPageChange) === null || _b === void 0 ? void 0 : _b.call(_a, currentPage);
      }
    });
  }
  onInputChange(value) {
  ...
  handleLeftPageChange(currentPage) {
  ...
  renderLeft(locale) {
    ...
    const pageSize = (_a = pagination === null || pagination === void 0 ? void 0 : pagination.pageSize) !== null && _a !== void 0 ? _a : _constants.numbers.DEFAULT_PAGE_SIZE;
    ...
    switch (true) {
      ...
      case !noMatch && (type === _constants.strings.TYPE_LIST || type === _constants.strings.TYPE_GROUP_LIST):
        content = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, headerCom, this.renderLeftList(paginatedData), hasPagination && totalPage > 1 && (/*#__PURE__*/_react.default.createElement("div", {
          className: `${prefixCls}-left-pagination`
  ...
  renderVirtualizedSelectedList(selectedData) {
    const {
      virtualize
    } = this.props;
    ...
    const OuterElement = /*#__PURE__*/_react.default.forwardRef((props, ref) => (/*#__PURE__*/_react.default.createElement("div", Object.assign({}, props, {
      ref: ref,
      role: "list",
    ...
    if (typeof height !== 'number') {
      ...
      }, /*#__PURE__*/_react.default.createElement(_autoSizer.default, {
  ...
  renderRight(locale) {
    ...
    const selectedData = [...selectedItems.values()].map(item => Object.assign(Object.assign({}, item), {
    ...
    const shouldVirtualize = virtualize && !(0, _isEmpty2.default)(virtualize);
    switch (true) {
      // when empty
