...
Object.defineProperty(exports, "MCPConfigure", {
  enumerable: true,
  get: function () {
    return _mcpConfigure.default;
  }
});
...
Object.defineProperty(exports, "SplitTagGroup", {
  enumerable: true,
  get: function () {
    return _splitTagGroup.default;
  }
});
...
var _splitTagGroup = _interopRequireDefault(require("./tag/splitTagGroup"));
...
var _mcpConfigure = _interopRequireDefault(require("./sideBar/mcpConfigure"));
var _annotation = _interopRequireDefault(require("./sideBar/annotation"));
