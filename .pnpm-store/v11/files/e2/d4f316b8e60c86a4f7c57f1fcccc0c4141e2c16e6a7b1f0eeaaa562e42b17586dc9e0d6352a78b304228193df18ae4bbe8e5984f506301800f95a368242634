  ...
  constructor(props) {
    ...
    this.renderSelection = () => {
      const _a = this.props,
        ...
        rest = __rest(_a, ["disabled", "multiple", "filterTreeNode", "validateStatus", "prefix", "suffix", "style", "size", "insetLabel", "className", "placeholder", "showClear", "leafOnly", "searchPosition", "triggerRender", "borderless", "autoMergeValue", "checkRelation", "triggerTagWrap"]);
      const {
        inputValue,
        selectedKeys,
        checkedKeys,
...
TreeSelect.propTypes = {
  ...
  triggerTagWrap: _propTypes.default.bool
};
