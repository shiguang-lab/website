...
class DropdownItemInner extends BaseComponent {
  render() {
    const {
      children,
      disabled,
...
DropdownItemInner.contextType = DropdownContext;
...
const DropdownItem = /*#__PURE__*/React.forwardRef((props, ref) => {
  return /*#__PURE__*/React.createElement(DropdownItemInner, Object.assign({}, props, {
    innerRef: ref
  }));
});
