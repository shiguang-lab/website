...
class Table extends _baseComponent.default {
    ...
    return Object.assign(Object.assign({}, super.adapter), {
      ...
      getCheckRelation: () => {
        ...
        if (rowSelection && typeof rowSelection === 'object') {
          return (0, _get2.default)(rowSelection, 'checkRelation', 'unRelated');
        }
        return 'unRelated';
      },
  ...
  constructor(props, context) {
    ...
    this.syncTableWidth = () => {
      var _a;
      const wrapper = (_a = this.rootWrapRef) === null || _a === void 0 ? void 0 : _a.current;
      if (!wrapper) {
        return;
      }
    ...
    this.observeTableWrapperResize = () => {
      ...
      const RO = (0, _get2.default)(window, 'ResizeObserver');
      if (!RO) {
        return;
      }
      this.resizeObserver = new RO(_entries => {
    ...
    this.needSyncTableWidth = () => this.adapter.isAnyColumnFixed() || this.props.showHeader && this.adapter.useFixedHeader();
  ...
  componentDidMount() {
    ...
    const checkRelation = (0, _get2.default)(this.state.rowSelection, 'checkRelation', 'unRelated');
  ...
  componentDidUpdate(prevProps, prevState) {
     ...
     */
    const nextGetCheckboxProps = (0, _get2.default)(this.props.rowSelection, 'getCheckboxProps');
    const prevGetCheckboxProps = (0, _get2.default)(prevProps.rowSelection, 'getCheckboxProps');
...
Table.propTypes = {
  ...
  getVirtualizedListRef: _propTypes.default.func,
  rowSpanHover: _propTypes.default.bool
};
Table.defaultProps = {
