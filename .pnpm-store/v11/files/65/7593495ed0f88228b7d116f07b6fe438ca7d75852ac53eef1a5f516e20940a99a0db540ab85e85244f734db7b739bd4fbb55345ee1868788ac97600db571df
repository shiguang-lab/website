...
class TextArea extends BaseComponent {
  constructor(props) {
    ...
    this.throttledNotifyNativeResize = _throttle(this.handleNativeResize, 10);
  ...
  render() {
    ...
    const itemProps = Object.assign(Object.assign({}, _omit(rest, 'insetLabel', 'insetLabelId', 'getValueLength', 'onClear', 'showClear', 'disabledEnterStartNewLine', 'composition')), {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      ref: this.setRef
    })))) : shouldObserveNativeResize ? (/*#__PURE__*/React.createElement(ResizeObserver, {
