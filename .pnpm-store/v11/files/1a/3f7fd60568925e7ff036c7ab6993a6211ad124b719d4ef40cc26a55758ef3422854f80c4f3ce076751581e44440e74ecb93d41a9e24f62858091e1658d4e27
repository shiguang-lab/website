...
class Transfer extends BaseComponent {
  ...
  renderLeft(locale) {
    ...
    const pageSize = (_a = pagination === null || pagination === void 0 ? void 0 : pagination.pageSize) !== null && _a !== void 0 ? _a : numbers.DEFAULT_PAGE_SIZE;
    ...
    switch (true) {
      ...
      case !noMatch && (type === strings.TYPE_LIST || type === strings.TYPE_GROUP_LIST):
        content = /*#__PURE__*/React.createElement(React.Fragment, null, headerCom, this.renderLeftList(paginatedData), hasPagination && totalPage > 1 && (/*#__PURE__*/React.createElement("div", {
  ...
  renderVirtualizedSelectedList(selectedData) {
    ...
    const OuterElement = /*#__PURE__*/React.forwardRef((props, ref) => (/*#__PURE__*/React.createElement("div", Object.assign({}, props, {
      ref: ref,
      role: "list",
  ...
  renderRight(locale) {
    ...
    const shouldVirtualize = virtualize && !_isEmpty(virtualize);
    switch (true) {
      // when empty
