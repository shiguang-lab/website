...
import { convertDataToEntities, calcMergeType, getKeyByValuePath, getValueOrKey } from '@douyinfe/semi-foundation/lib/es/cascader/util';
...
class Cascader extends BaseComponent {
  ...
  componentDidUpdate(prevProps) {
    ...
    const treeDataChanged = !_isEqual(prevProps.treeData, this.props.treeData);
    const keyMapsChanged = !_isEqual(prevProps.keyMaps, this.props.keyMaps);
