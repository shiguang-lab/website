...
function renderDropdown(props) {
  ...
  const render = typeof renderFilterDropdown === 'function' ? renderFilterDropdown(renderFilterDropdownProps) : (/*#__PURE__*/_react.default.createElement(_dropdown.default.Menu, null, Array.isArray(filters) && filters.map((filter, index) => {
    ...
    return item;
  }), filterConfirmMode === 'confirm' && level === 0 && (/*#__PURE__*/_react.default.createElement("div", {
    style: {
      padding: '8px 12px',
  ...
  }, (locale === null || locale === void 0 ? void 0 : locale.resetFilter) || 'Reset'), /*#__PURE__*/_react.default.createElement(_button.default, {
    size: "small",
    theme: "solid",
...
function ColumnFilter() {
  ...
  const [initialFilteredValue, setInitialFilteredValue] = (0, _react.useState)(filteredValue);
  ...
  return /*#__PURE__*/_react.default.createElement(_localeConsumer.default, {
    ...
    if (/*#__PURE__*/_react.default.isValidElement(filterDropdown)) {
