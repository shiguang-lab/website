  ...
  if (name === 'android') {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M4.6 17.2c0-4.2 3.3-7.4 7.4-7.4s7.4 3.2 7.4 7.4H4.6z" />
        <path d="m7 7.2-1.5-2.6M17 7.2l1.5-2.6" />
        <circle cx="9" cy="13.9" r="0.4" fill="currentColor" />
        <circle cx="15" cy="13.9" r="0.4" fill="currentColor" />
      </svg>
    );
  }
  if (name === 'windows') {
